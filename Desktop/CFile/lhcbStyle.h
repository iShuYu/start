...
///////////////////////////////////////////////////////////////////
  ...
  // add LHCb label
  lhcbName = new TPaveText(gStyle->GetPadLeftMargin() + 0.05, 0.60 - gStyle->GetPadTopMargin(), gStyle->GetPadLeftMargin() + 0.20, 0.95 - gStyle->GetPadTopMargin(),
  //TPaveText *lhcbName = new TPaveText(gStyle->GetPadLeftMargin() + 0.05, 0.81 - gStyle->GetPadTopMargin(), gStyle->GetPadLeftMargin() + 0.20, 0.95 - gStyle->GetPadTopMargin(),
                           "BRNDC");//0.12
  ...
  lhcbName->AddText("#sqrt{s} = 5 TeV");
  //lhcbName->AddText("LHCb #sqrt{s} = 7 TeV");
